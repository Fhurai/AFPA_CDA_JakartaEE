...
<main>
    <article>
        ...
        <section class="container" id="content">
            ...
            <a
                    class="btn btn-primary float-end d-flex"
                    href="?cmd=clients/create">
        ...
        <div class="hovertable">
            <div class="hovertable-head">
                <div class="hovertable-row">
                    ...
                    <div class="hovertable-cell handlewidth">Chiffre
                        d'affaires
                    </div>
            ...
            <div class="hovertable-body">
                <div class="hovertable-row">
                    ...
                    <div class="hovertable-cell longer">2 bis rue Ardant du Picq
                        57004 Metz
                    </div>
                ...
                <div class="hovertable-row">
                    ...
                    <div class="hovertable-cell longer">25 rue de la Taye 57130
                        Jussy
                    </div>
                ...
                <div class="hovertable-row">
                    ...
                    <div class="hovertable-cell longer">3 rue des Michottes
                        54000 Nancy
                    </div>
                    <div class="hovertable-cell ">0383375640</div>
                    <div class="hovertable-cell long">
                        contact@monolith-soft.com
                    </div>
