...
<head>
    ...
    <title>Suppression Clients | Gestion Clients</title>
</head>
<body>
<jsp:include page="../components/header.jsp"/>
<main>
    <article>
        <header><h1>Suppression</h1></header>
        <section class="container" id="content"><span class="handlewidth">Vous souhaitez supprimer les données ?</span>
        </section>
        <form action="#" method="post">
            <fieldset class="row modal-dialog-centered"><input type="hidden"
                ...
                <div class="form-group col-md-6"><label
                        ...
                        placeholder="Ville" size="30" disabled=""></div>
                ...
                <div class="form-group col-md-12">
                    <button class="btn btn-primary float-end">Supprimer</button>
                </div>
            </fieldset>
        </form>
    </article>
